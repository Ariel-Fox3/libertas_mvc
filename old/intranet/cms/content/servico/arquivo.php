...
$(document).ready(function() {
  ...
  $('a.removeArquivo').click(function() {
    ...
    $.post('servico/ajax/ajax_arquivo_del.php', {
      id: del_id
    }, function(data) {
...
<div class="card">
  <div class="card-header">Anexar imagens (<b><?=$servico->getNome()?></b>)</div>
  <div class="card-body">
    <form id="formArquivo" action="servico/ajax/ajax_arquivo.php" name="formCadastro" method="post" role="form"
...
<div class="card mt-5">
  ...
  <div class="card-body">
    <div id="tabela-arquivos">
      <?php
        $listArquivos = $arquivoDAO->getByIdservico($idservico);
