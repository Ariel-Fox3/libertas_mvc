...
<div class="card">
  <div class="card-header">Nova categoria de produto</div>
  <div class="card-body">
    <form id="formCriarCategoria" action="categoria_produto/ajax/ajax_add.php" name="formCadastro" method="post" role="form" enctype="multipart/form-data">
