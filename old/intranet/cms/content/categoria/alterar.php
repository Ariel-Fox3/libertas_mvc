...
<div class="card">
  <div class="card-header">Alterar categoria <b><?=$categoria->getNome()?></b></div>
  <div class="card-body">
    <form id="formCriarCategoria" action="categoria/ajax/ajax_alt.php" name="formCadastro" method="post" role="form" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-8">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="inputNome" id="inputNome" required value="<?=$categoria->getNome()?>">
          </div>
          <div class="form-group">
            <label for="inputDescricao">Descrição</label>
            <textarea class="summernote" name="inputDescricao"><?=$categoria->getDescricao()?></textarea>
          </div>
        </div>
        <div class="col-4">
          <div class="form-group">
            ...
            <div class="input-group mb-1">
              <?php if ($categoria->getImagem() != '') { ?>
                <div class="input-group-prepend">
                  <a class="btn btn-secondary" data-fancybox="gallery" href="../../uploads/<?=$categoria->getImagem()?>" data-toggle="tooltip" title="Ver imagem atual" type="button" id="button-addon1"><i class="fas fa-eye"></i></a>
                </div>
              <?php } ?>
      ...
      <!-- <div class="row">
        <div class="col text-left">
          <div class="checkbox center mb-3">
            <input type="checkbox" name="inputAtivo" value="1" class="switch_1" <?=$categoria->getAtivo() == 1 ? 'checked' : ''?>>
