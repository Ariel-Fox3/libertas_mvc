...
$(document).ready(function() {
  ...
  $('a.removeArquivo').click(function() {
    ...
    $.post('produto/ajax/ajax_arquivo_del.php', {
      id: del_id
    }, function(data) {
...
<div class="card">
  <div class="card-header">Anexar imagens (<b><?=$produto->getNome()?></b>)</div>
  <div class="card-body">
    <form id="formArquivo" action="produto/ajax/ajax_arquivo.php" name="formCadastro" method="post" role="form"
...
<div class="card mt-5">
  ...
  <div class="card-body">
    <div id="tabela-arquivos">
      <?php
        $listArquivos = $arquivoDAO->getByIdproduto($idproduto);
