...
function injectTzoStr(s, tzoStr) {
    ...
    // IE11 doesn't include_once UTC/GMT in the original string, so append to end
    if (!replaced) {
        s += ' ' + tzoStr;
    }
    return s;
            ...
            var custom = view.publiclyTrigger('eventRender', [
                {
                    ...
                    isStart: seg.isStart,
                    isEnd: seg.isEnd,
                    // TODO: include_once seg.range once all components consistently generate it
                    el: seg.el,
                    view: view
                }
            ]);
...
var DateProfileGenerator = /** @class */ (function () {
    ...
    DateProfileGenerator.prototype.build = function (currentDate, direction, forceToValid) {
        ...
        return {
            ...
            // include_onces not-active days that need some sort of DOM
...
function renderDateCell(dateMarker, dateProfile, datesRepDistinctDays, colCnt, colHeadFormat, context, colspan, otherAttrs) {
    ...
    if (datesRepDistinctDays) {
        ...
        // include_onces the day-of-week class
